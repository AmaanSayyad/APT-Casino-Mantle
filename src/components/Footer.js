...
export default function Footer() {
  ...
  const paymentMethods = [
    { name: "MNT", icon: "/icons/eth.svg" },
    { name: "MNT", icon: "/icons/apt.svg" },
  ];
          ...
          <div className="p-[1px] bg-gradient-to-r from-red-magic/40 to-blue-magic/40 rounded-lg mb-6 hover:from-red-magic hover:to-blue-magic transition-all duration-300">
            <div className="bg-[#120010] rounded-lg p-4">
              <p className="text-white/80 text-sm leading-relaxed">
                APT-Casino is your ultimate destination for Mantle Network gaming. Experience transparency, fairness,
                and excitement powered by Mantle blockchain technology.
              </p>
            </div>
          </div>
