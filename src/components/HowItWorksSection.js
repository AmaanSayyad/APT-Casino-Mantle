...
const HowItWorksSection = () => {
  ...
  const steps = [
    ...
    {
      id: 2,
      title: 'Get MNT tokens',
      description: 'Power your gameplay with MNT tokens of Mantle Sepolia Network.',
      emoji: '💰'
    },
    {
      id: 3,
    ...
    },
    {
      id: 4,
      title: 'Earn Rewards',
      description: 'Win MNT tokens and unlock exclusive perks through our multi-tiered loyalty program. Earn cashback on losses and gain access to tournaments.',
      emoji: '🏆'
    },
  ];
