  ...
  const testimonials = [
    {
      ...
      rating: 5,
              text: 'APT Casino offers the most transparent gaming experience I\'ve found on Mantle Network. The provably fair system gives me confidence that games are legitimate, and I\'ve already won over 500 MNT tokens!',
      game: 'Roulette',
      amount: 520
    },
    {
    ...
    },
    {
      ...
      rating: 5,
      text: 'The DeFi lending integration is brilliant. I was able to use my collateral to borrow MNT for games, and when I won big, I paid back the loan and kept the profits. Smart financial gaming!',
      game: 'Fortune Tiger',
      amount: 876
    },
    {
                ...
                <div className="mt-auto pt-6 border-t border-white/10">
                  <div className="flex justify-between">
                    ...
                    <div>
                      ...
                      <p className="text-white font-bold">{testimonials[activeIndex].amount} MNT</p>
                    </div>
                  </div>
                </div>
              </div>
